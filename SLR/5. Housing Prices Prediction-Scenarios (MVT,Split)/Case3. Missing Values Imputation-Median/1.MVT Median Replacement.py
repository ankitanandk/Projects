...
As the data is moderately skewed with a value of 1.26, we can use the median for the MVT
...
reg.fit(X,Y)
#Estimating the price for a 3300 square feet home, the value come out to be 610593,
#with mean imputation it was 634223

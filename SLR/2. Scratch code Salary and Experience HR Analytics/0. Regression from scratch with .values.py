...
'''collecting X and Y data from the data frame to one dimension numpy arrays 
look at the size in Variable explorer for more clarity and understanding
In scratch code even if you go with the data series( One variable of frame), it is fine.
converting to array help in faster execution 
and models that are based on huge data do not go well with a dataframe at times
'''
X=df['YearsExperience'].values
Y=df['Salary'].values

'''Look at the console for the type of X and its dimension, it is a numpy array and 1 dimension :)'''
print(type(X),X.ndim)
